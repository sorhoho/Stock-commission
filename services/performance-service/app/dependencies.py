"""FastAPI dependency providers for performance-service."""
...
async def get_kafka_producer(request: Request) -> KafkaProducer:
    """Return the app-level Kafka producer from request app state."""
...
def get_correlation_id(request: Request) -> str:
    """Return correlation_id injected by CorrelationMiddleware."""
